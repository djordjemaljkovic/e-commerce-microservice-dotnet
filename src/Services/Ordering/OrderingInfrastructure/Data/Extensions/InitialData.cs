...
namespace OrderingInfrastructure.Data.Extensions
{
    public class InitialData
    {
        ...
        new List<Customer>
        {
            Customer.Create(CustomerId.Of(new Guid("58c49479-ec65-4de2-86e7-033c546291aa")), "djordje", "djordje@gmail.com"),
            Customer.Create(CustomerId.Of(new Guid("189dc8dc-990f-48e0-a37b-e6f2b60b9d7d")), "jovana", "jovana@gmail.com")
        };
        ...
        public static IEnumerable<Order> OrdersWithItems
        {
            get
            {
                var address1 = Address.Of("djordje", "maljkovic", "djordje@gmail.com", "Save Kovacevica", "Serbia", "Belgade", "11080");
                var address2 = Address.Of("jovana", "todorovic", "jovana@gmail.com", "Altina", "Serbia", "Belgade", "11080");

                var payment1 = Payment.Of("djordje", "5555555555554444", "12/28", "355", 1);
                var payment2 = Payment.Of("jovana", "8885555555554444", "06/30", "222", 2);
